    ...
    <div class="about-desc">
        <div class="about-des">
            ...
            <p>
                ...
                At Syntax, we specialize in curating a diverse collection of shoes, bags, eye-glasses, rings, wrist-watches, 
                and an array of other accessories that cater to your fashion needs.
                ...
                But that's not all  our inventory spans an extensive array of accessories that encompass the latest trends and timeless classics.
                At Syntax, we pride ourselves on offering not just products, but experiences. Our commitment to quality, style, and customer satisfaction is unwavering. Whether you're seeking the perfect accessory for a special occasion or a staple piece for everyday wear, Syntax is here to cater to your diverse tastes and preferences.
        ...
        <div class="delive-info">
            ...
            <p>
                ...
                Home Delivery:
                Experience the ease of shopping from the comfort of your home and having your chosen items delivered right to your doorstep. Our reliable and efficient delivery partners ensure that your package arrives safely and promptly. Enjoy the convenience of tracking your order every step of the way, so you're always informed about its status.
                Pickup:
                ...
                For our global clientele, we offer international shipping to bring the elegance of Syntax accessories right to your doorstep, no matter where you are in the world. Experience our seamless international delivery service that ensures your items reach you securely and on time.
                Customized Delivery Services:
                At Syntax, we prioritize our customers' needs. If you have specific delivery preferences or requirements, our customer service team is here to assist you. Whether it's a gift delivery, special packaging, or any other personalized request, we strive to accommodate your needs to make your shopping experience exceptional.
                Our commitment to providing flexible and efficient delivery options is aimed at ensuring that your experience with Syntax is not just about acquiring exquisite accessories but also about enjoying a hassle-free and tailored service that caters to your lifestyle and preferences.
            </p>
        </div>
